...
private configurarManifestDinamico(tienda: any) {
  ...
  const miManifestDinamico = {
    ...
    icons: [
      ...
      {
        src: tienda.img || 'assets/icons/icon-96x96.png',
        sizes: '96x96',
        type: 'image/png',
        purpose: 'any maskable'
      },
      {
        src: tienda.img || 'assets/icons/icon-128x128.png',
        sizes: '128x128',
        type: 'image/png',
        purpose: 'any maskable'
      },
      {
        src: tienda.img || 'assets/icons/icon-144x144.png',
        sizes: '144x144',
        type: 'image/png',
        purpose: 'any maskable'
      },
      {
        src: tienda.img || 'assets/icons/icon-152x152.png',
        sizes: '152x152',
        type: 'image/png',
        purpose: 'any maskable'
      },
      ...
      {
        // Usamos el logo que el restaurante subió a Cloudinary como icono de la App
        src: tienda.img || 'assets/icons/icon-384x384.png',
        sizes: '384x384',
        type: 'image/png',
        purpose: 'any maskable'
      },
