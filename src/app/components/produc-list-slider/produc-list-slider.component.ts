...
@Component({
  selector: 'app-produc-list-slider',
  imports: [CommonModule],
  templateUrl: './produc-list-slider.component.html',
  styleUrl: './produc-list-slider.component.scss'
})
export class ProducListSliderComponent implements OnInit {
@Input() productsList: Producto[] = [];
  ...
  activeCategory: string = 'Pastichos';
